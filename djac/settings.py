"""
Django settings for djac project.
...
INSTALLED_APPS = [
    ...
    'djac',
] + site_settings.DJAC_INSTALLED_APPS
...
] + site_settings.DJAC_MIDDLEWARE

ROOT_URLCONF = 'djac.urls'
...
WSGI_APPLICATION = 'djac.wsgi.application'
